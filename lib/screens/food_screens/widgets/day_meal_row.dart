...
class _DayMealRowState extends State<DayMealRow> {
  ...
  Widget build(BuildContext context) {
    ...
    widget.mealsProvider.getSelectedMeal(widget.index);
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              GestureDetector(
                onTap: () => _showDropdown(context, selectedValue),
                child: Container(
                      ...
                      return Column(
                        children: [
                          ListTile(
                            ...
                            onTap: () {
                              widget.mealsProvider.updateSelectedMeal(
                                  widget.index, _filteredItems[index]);
